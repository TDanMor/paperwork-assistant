  ...
  return (
    <div className="page-container" style={{ maxWidth: '850px', margin: '0 auto' }}>
      ...
      <section className="settings-card">
        ...
        <p className="muted" style={{ marginBottom: '1rem' }}>{t('settings.model_status')}: <strong>{t(`model.${state.modelStatus}`)}</strong>{state.modelStatus === 'loading' && ` — ${state.modelProgress}%`}{state.modelStatus === 'ready' && ' ✅'}</p>
